...
|sdgRegion                                 |character |Name of the region where the city is located. |
|dataSource                                |character |Source: UN-Habitat Urban Indicators Database. |
...
|greenAreaPerCapitaM2                      |double    |Amount of green area per capita in m2 per city. |
